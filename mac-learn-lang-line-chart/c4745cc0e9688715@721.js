...
function _getTags(selectLines,tags)
{
    switch(selectLines) {
      case "All":
        return tags;
      case "Excluding python":
        return tags.filter(words => words !== "python");
      case "Excluding python and r":
        return tags.filter(words => words !== "python" && words !== "r");
    }
}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["machine_learning_languages_results.csv", {url: new URL("./files/948be3375694a22dc2b1e1c5ba6569932efcab728a4cf749b6de5f95a0fd3923eea808a070a61330a606ae137e44bdb43f89f9235a844a879385b57cb52c62ff", import.meta.url), mimeType: "text/csv", toString}]
  ]);
  ...
  main.variable(observer("getTags")).define("getTags", ["selectLines","tags"], _getTags);
