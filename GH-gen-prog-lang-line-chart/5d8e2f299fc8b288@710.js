...
md`# GH General Programming Languages
...
LineChart(data.slice(49,).filter(d => Tags.includes(d.language)), {
  x: d => d.date,
  y: d => d.percent,
  z: d => d.language,
...
d3.csvParse(await FileAttachment("gh_general_languages_results.csv").text(), d3.autoType)
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["gh_general_languages_results.csv", {url: new URL("https://raw.githubusercontent.com/aggarwalc/le-data-2.0-DATA/main/GitHub/gh-general-languages/gh_general_languages_results.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
