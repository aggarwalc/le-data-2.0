...
d3.csvParse(await FileAttachment("machine_learning_libraries_results.csv").text(), d3.autoType)
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["machine_learning_libraries_results.csv", {url: new URL("https://raw.githubusercontent.com/aggarwalc/le-data-2.0-DATA/main/Stack-Overflow/machine-learning-libraries/machine_learning_libraries_results.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
