...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["app_development_results.csv", {url: new URL("https://raw.githubusercontent.com/aggarwalc/le-data-2.0-DATA/main/Stack-Overflow/app-dev/app_development_results.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
